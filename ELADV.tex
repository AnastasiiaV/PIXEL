...
\begin{figure}[t!]
  \centering
  \includegraphics[trim=0.5cm 0.5cm 0.5cm 2.1cm, width = 0.18\textwidth, clip]{figures/eps/ns.eps}\put(-25,-15){a)}\put(-60,190){RO$_{\textrm{l}}$}\put(-15,190){RO$_{\textrm{r}}$}
  \includegraphics[trim=0.cm -8cm 0.cm 0.cm, height=6.1cm]{figures/eps/neladleg.pdf}
  \hfill
  \includegraphics[trim=0.5cm 0.5cm 0.5cm 2.1cm, width = 0.18\textwidth, clip]{figures/eps/ns_ef.eps}\put(-35,-15){b)}
  \includegraphics[trim=0.cm -9cm 0.cm 0.cm, height=6.1cm]{figures/eps/nelad_ef_leg.pdf}
  \hfill
  \includegraphics[trim=0.5cm 0.5cm 0.5cm 2.1cm, width = 0.18\textwidth, clip]{figures/eps/nelad.eps}\put(-25,-15){c)}\put(-60,190){RO$_{\textrm{l}}$}\put(-15,190){RO$_{\textrm{r}}$}
  \includegraphics[trim=0.cm -8cm 0.cm 0.cm, height=6.1cm]{figures/eps/neladleg.pdf}
  \hfill
  \includegraphics[trim=0.5cm 0.5cm 0.5cm 2.1cm, width = 0.18\textwidth, clip]{figures/eps/nelad_ef.eps}\put(-35,-15){d)}
  \includegraphics[trim=0.cm -9cm 0.cm 0.cm, height=6.1cm]{figures/eps/nelad_ef_leg.pdf}
  \caption{
...
\begin{figure}[t!]
  ...
  \caption{
The hole current density for a) - d) the n-ELAD sensor with $n\mathrm{_{di}} =2.8\mathrm{\cdot10^{15}\,cm^{-3}}$ and e) a standard planar n-sensor is shown at four different points in time for a MIP incident of 16.9\,$\muup$m at $U=280$\,V.
}
  \label{fig:tr}
\end{figure}
