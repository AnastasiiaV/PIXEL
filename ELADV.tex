...
\begin{figure}[t!]
  \centering
  \includegraphics[trim=0.5cm 0.5cm 0.5cm 2.1cm, width = 0.18\textwidth, clip]{figures/ns.eps}\put(-30,-7){a)}\put(-58, 192){$\mathrm{RO_{l}}$}\put(-15, 192){$\mathrm{RO_{r}}$}\put(-88,100){\rotatebox{90}{\small Y [um]}}
...
\begin{figure}[t!]
  \centering
  \includegraphics[trim=0.5cm 0.5cm 0.5cm 2.1cm, clip, width=0.18\textwidth]{figures/tr_1.eps}\put(-60,-15){a) $t=0.0$\,ns}\put(-57, 20){\small5}\put(-44, 20){\small20}\put(-28, 20){\small35}\put(-12, 20){\small50}\put(-88,100){\rotatebox{90}{\small Y [um]}}
