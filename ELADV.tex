...
Arrows indicate the direction of the total field strength. 
}
  \label{fig:geom}
\end{figure}
...
\begin{figure}[t!]
  \centering
  \includegraphics[width=0.20\textwidth]{figures/nelad2_pp}\put(-30,-15){a)}
  \includegraphics[width=0.20\textwidth]{figures/pssel.pdf}\put(-30,-15){b)}
  \includegraphics[width=0.20\textwidth]{figures/nelad2_pp}\put(-30,-15){c)}
  \includegraphics[width=0.20\textwidth]{figures/peladel.pdf}\put(-30,-15){d)}
  \hfill 
...
\begin{figure}[t!]
  ...
  \hfill 
  %\includegraphics[height=6.1cm]{figures/EF1Dcomparison.pdf}\put(-100,5){b)}
...
\begin{figure}[t!]
  \centering
  \includegraphics[width=0.185\textwidth]{figures/tr1_pp.pdf}\put(-60,-15){a) t~=~0.0\,ns}
  \includegraphics[width=0.185\textwidth]{figures/tr2_pp.pdf}\put(-60,-15){b) t~=~0.4\,ns}
  \includegraphics[width=0.185\textwidth]{figures/tr3_pp.pdf}\put(-60,-15){c) t~=~0.8\,ns}
  \includegraphics[width=0.185\textwidth]{figures/tr4_pp.pdf}\put(-60,-15){d) t~=~2.0\,ns}
  \includegraphics[width=0.185\textwidth]{figures/transn_pp.pdf}\put(-60,-15){e) t~=~2.0\,ns}
  \hfill 
