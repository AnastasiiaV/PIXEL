...
Our realisation of an ELAD sensor contains two types of deep implants: p-implants and n-implants, effectively reducing the impact of the additional fixed charges on $\mathrm{N_{eff}}$~\cite{elad}. 
...
\begin{figure}[b!]
  \centering
  \includegraphics[trim={1.cm 0cm 1.cm 0cm}, width = 0.48\textwidth]{figures/neladConc.eps}\put(-210,200){a)}
  \includegraphics[trim={1.cm 0cm 1.cm 0cm}, width = 0.48\textwidth]{figures/peladConc.eps}\put(-210,200){b)}
  \caption[]{
...
\begin{figure}[t!]
  \centering
  \includegraphics[trim={1.cm 0cm 1.cm 0cm}, width = 0.48\textwidth]{figures/neladRO.eps}\put(-210,200){a)}
